...
struct OffPlanMealEditor: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                Section("Off-plan meal") {
                    TextField("Description (e.g. Chipotle chicken bowl)", text: $description, axis: .vertical)
                        .lineLimit(2...4)
                }
